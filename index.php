...
<body>
    ...
    <div class="wrapper bg-dark">
                        ...
                        <div class="col-md-4 col-sm-5">
                            <div class="booking-box">
                                <div class="booking-title">
                                    <h3>Book A Room</h3>
                                    <p>Berbagai pilihan desain kamar yang dapat anda pilih secara harian atau bulanan</p>
                                </div>
                                <div class="booking-form">
                                    <form action="#">
                                        <div class="b-date arrive mb-15">
                                            <input class="date-picker" type="text" placeholder="Waktu Check-In">
                                            <i class="mdi mdi-calendar-text"></i>
                                        </div>
                                        <div class="b-date departure mb-15">
                                            <input class="date-picker" type="text" placeholder="Waktu Check-Out">
                                            <i class="mdi mdi-calendar-text"></i>
                                        </div>
                                        <div class="select-book mb-15">
                                            <select name="book" class="select-booking">
                                                ...
                                                <option value="1">5-6 orang</option>
                                            </select>
                                        </div>
                                        <div class="select-book  mb-15">
                                            <select name="book" class="select-booking">
                                                ...
                                                <option value="1">President Suite</option>
                                            </select>
                                        </div>
                                        <div class="select-book  mb-30">
                                            <select name="book" class="select-booking">
                                                <option value="" selected>Jenis Layanan</option>
        ...
        <div class="about-section text-center pt-80  ">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title mb-80">
                            <h2>About <span>Syaqilla Residence</span></h2>
                            <p>Syaqilla Residence - Medan terletak di tengah kota Medan, tepatnya di Jalan STM Sukaria No. 8 Medan dan hanya 60 menit dari Bandara Internasional Kuala namu dengan mobil dan sangat dekat dengan berbagai perkantoran maupun Universitas. Residence ini menawarkan kamar dan suite dengan pemandangan nuansa desain Timur Tengah (Marocco) yang memukau dengan paduan taman yang asri</p>
                        </div>
                    </div>
                    <div class="col-md-12">
        ...
        <!--About Section end-->
        <!--Our Room start-->
        <div class="our-room text-center pt-80">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
        ...
        <!--Our room end-->
        <!--Our services start-->
        <div class="our-sevices text-center ptb-80">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title mb-80">
                                        ...
                                        <div class="services-hover-inner">
                                            <div class="services-hover-table">
                                                <div class="services-hover-table-cell">
                                                    <h2>Easy Access</h2>
                                                    <p>Lokasi berada di jalan besar STM Sukaria</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="services-hover-desc">
                                        <div class="services-hover-inner">
                                            <div class="services-hover-table">
                                                <div class="services-hover-table-cell">
                                                    <h2>Cheap Price</h2>
                                                    <p>Harga kamar yang kami tawarkan sangat terjangkau bila dibangdingkan dengan yang lain</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="services-hover-desc">
                                        <div class="services-hover-inner">
                                            <div class="services-hover-table">
                                                <div class="services-hover-table-cell">
                                                    <h2>24/7 Reception</h2>
                                                    <p>Layanan 24 jam untuk mempermudah proses check-in tamu yang mempunyai tingkat kesibukan yang tinggi</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="services-hover-desc">
                                        <div class="services-hover-inner">
                                            <div class="services-hover-table">
                                                <div class="services-hover-table-cell">
                                                    <h2>Security 24 Hours</h2>
                                                    <p>Keamanan 24 jam untuk memberikan kenyamanan para tamu dalam menginap</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <!-- <div class="section-title mb-100">
                            <h2>Our <span>Testimonials</span></h2> -->
                                ...
                                <div class="staff-tesimonial text-center  ">
 ...
 -->
    ...
    street Crossroad123.</p>
                            ...
                            <div class="hotel-contact">
                                ...
                                <p><span>Email:</span> chondohotel@email.com</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-8 col-xs-12">
                        <p>Copyright© CHONDO 2016.All right reserved.Created by <a href="http://bootexperts.com">HasTech</a></p>
                    </div>
        ...
        <script>
            function initialize() {
              var mapOptions = {
                zoom: 15,
                scrollwheel: false,
                center: new google.maps.LatLng(3.5461475, 98.6922799)
              };
