...
<head>
    ...
    <title>Chondo Hotel | Gallery 2</title>
...
<body>
    ...
    <div class="wrapper bg-dark">
        ...
        <!-- search bar End -->
        <!--Gallery Title start-->
        <div class="room-gallery ptb-80 text-center  ">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="our-gallery-show">
                <div class="gallery-top">
                    <div class="separate-gallery-item left pr-25">
                        <div class="single_gallery pb-30">
                            <div class="single_gallery_inner">
                               <a href="images/gallery/item4/g-1.jpg">
                                    <img src="images/gallery/item4/g-1.jpg" alt="">
                                    <div class="single_gallery-hover">
                        ...
                        <div class="single_gallery small">
                            <div class="single-gallery-subitem pr-15">
                                <div class="single_gallery_inner">
                                    <a href="images/gallery/item4/g-5.jpg">
                                        <img src="images/gallery/item4/g-5.jpg" alt="">
                                        <div class="single_gallery-hover">
                                            <div class="gallery-desc">
                                                <span><i class="fa fa-search-plus"></i></span>
                                                <h3>Awesome  roome</h3>
                            ...
                            <div class="single-gallery-subitem pl-15">
                                <div class="single_gallery_inner">
                                   <a href="images/gallery/item4/g-6.jpg">
                                        <img src="images/gallery/item4/g-6.jpg" alt="">
                                        <div class="single_gallery-hover">
                                            <div class="gallery-desc">
                                                <span><i class="fa fa-search-plus"></i></span>
                                                <h3>Awesome  roome</h3>
                    ...
                    <div class="separate-gallery-item middle hidden-xs">
                        <div class="single_gallery">
                            <div class="single_gallery_inner">
                                <a href="images/gallery/item4/g-2.jpg">
                                    <img src="images/gallery/item4/g-2.jpg" alt="">
                                    <div class="single_gallery-hover">
                                        <div class="gallery-desc">
                                            <span><i class="fa fa-search-plus"></i></span>
                                            <h3>Awesome  roome</h3>
                    ...
                    <div class="separate-gallery-item right pl-25">
                        <div class="single_gallery small pb-30">
                            <div class="single-gallery-subitem pr-15">
                                <div class="single_gallery_inner">
                                    <a href="images/gallery/item4/g-3.jpg">
                                        <img src="images/gallery/item4/g-3.jpg" alt="">
                                        <div class="single_gallery-hover">
                                            <div class="gallery-desc">
                                                <span><i class="fa fa-search-plus"></i></span>
                                                <h3>Awesome  roome</h3>
                            ...
                            <div class="single-gallery-subitem pl-15">
                                <div class="single_gallery_inner">
                                    <a href="images/gallery/item4/g-4.jpg">
                                        <img src="images/gallery/item4/g-4.jpg" alt="">
                                        <div class="single_gallery-hover">
                                            <div class="gallery-desc">
                                                <span><i class="fa fa-search-plus"></i></span>
                                                <h3>Awesome  roome</h3>
                        ...
                        <div class="single_gallery">
                            <div class="single_gallery_inner">
                                <a href="images/gallery/item4/g-7.jpg">
                                    <img src="images/gallery/item4/g-7.jpg" alt="">
                                    <div class="single_gallery-hover">
                                        <div class="gallery-desc">
                                            <span><i class="fa fa-search-plus"></i></span>
                                            <h3>Awesome  roome</h3>
                ...
                <div class="gallery-bottom pt-30">
                    <div class="single_gallery pr-15">
                        <div class="single_gallery_inner">
                            <a href="images/gallery/item4/g-8.jpg">
                                <img src="images/gallery/item4/g-8.jpg" alt="">
                                <div class="single_gallery-hover">
                                    <div class="gallery-desc">
                                        <span><i class="fa fa-search-plus"></i></span>
                                        <h3>Awesome  roome</h3>
                    ...
                    <div class="single_gallery pl-15">
                        <div class="single_gallery_inner">
                            <a href="images/gallery/item4/g-9.jpg">
                                <img src="images/gallery/item4/g-9.jpg" alt="">
                                <div class="single_gallery-hover">
                                    <div class="gallery-desc">
                                        <span><i class="fa fa-search-plus"></i></span>
                                        <h3>Awesome  roome</h3>
