                                    ...
                                    <ul>
                                        <li><a href="#">home</a>
                                            <ul>
                                                ...
                                                <li><a href="index-2-box.html">HOme Tow box</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a href="#">pages</a>
                                            <ul>
                                                ...
                                                <li><a href="news-2.html">New two</a></li>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-6">
								<div class="adresses">
									<div class="phone">
										<p>call <span>+88 225 88 154 263</span></p>
									</div>
									<div class="email">
										<p>Email: <span>chondohtel@email.com</span></p>
									</div>
								</div>
							</div>
							<div class="col-md-6">
											...
											<div class="menu-list">
												<nav>
													<!-- <ul>
														...
														<li><a href="about-us.html">About</a></li>
														<li class="logo"><a href="index.html"><img src="images/logo/logo.png" alt=""></a></li>
														<li><a href="#">Feature</a></li>
														<li><a href="gallery-2.html">Gallery</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="services-tab-menu mb-70">
                            <ul class="nav" role="tablist">
                                ...
                                <li><a href="#reception" data-toggle="tab">presiden Suite</a></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="single-services">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="services-desc-inner">
                                            <h2>Superior room</h2>
                                            <p class="text1">Kamar modern yang luas dan modern memiliki tempat tidur king atau twin dengan lantai parket, brankas, internet nirkabel, meja kerja, pengering rambut, sofa, dan TV LCD 32 ”. Sarapan prasmanan gratis dan surat kabar harian, </p>
                                                <p class="text2">
                                                - 29.7m2 - 34.5m2 <br>
                                                - 124 kamar <br>
                                                - Lantai 5/10, lantai 12 <br>
                                                - Tempat Tidur Twin dan Tempat Tidur Double <br>
                                                - 51 Tempat Tidur Twin, 73 Tempat Tidur Double</p>
                                            <div class="room-book">
                                                <a href="#">Book now</a>
                                            </div>
                                        </div>
